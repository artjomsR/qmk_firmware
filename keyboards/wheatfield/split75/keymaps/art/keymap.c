...
//--------------------------------Left Hand-----------------------------------------------| |--------------------------------Right Hand------------------------------------------------
                      _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,
_______,  _______,    TILD_BLOCK, PRESCRIPTION, QUOTES_RU, _______,  FOURS,  _______,  _______,         _______,   _______,  PARENTHS, _______,  DASHES,   _______,  _______,           _______,
_______,  _______,    _______,  _______,  _______,  _______,  _______,  BEAT_BROWSER,         _______,  _______,   _______,  _______,  _______,  BRACES,   TOG_OS,   _______,           _______,
_______,  _______,    _______,  ADMINS,   SARCASM,  _______,  CTRL_CTV, _______,              _______,  _______,   _______,  _______,  _______,  QUOTES,   _______,                     _______,
_______,  _______,    _______,  _______,  _______,  CTRL_CAV, _______,  LMB_SPAM,             _______,  CTRL_LCTV, _______,  _______,  _______,                      _______, _______,  _______,
_______,  _______,    _______,  _______,  _______,  _______,  _______,                        _______,             _______,  _______,  _______,                      _______, _______,  _______
  ),
