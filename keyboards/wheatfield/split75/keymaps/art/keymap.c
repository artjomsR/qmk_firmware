...
DYN_REC_STOP,DYN_REC_START1,KC_LCTL, KC_LGUI, KC_LALT, LT(NAV,KC_SPC), LT(COMBOS,KC_BSPC),            LT(MEDIA, KC_ENTER),        KC_RALT, MO(LAYOUT_CHG),KC_RCTL,                     KC_LEFT,  KC_DOWN, KC_RIGHT
  ),
...
//--------------------------------Left Hand-----------------------------------------------| |--------------------------------Right Hand------------------------------------------------
                      _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,
_______,  _______,    TILD_BLOCK, PRESCRIPTION, QUOTES_RU, _______,  FOURS,  _______,  _______,         _______,   _______,  PARENTHS, _______,  _______,  _______,  _______,           _______,
_______,  _______,    _______,  _______,  _______,  _______,  _______,  BEAT_BROWSER,         _______,  _______,   _______,  _______,  _______,  BRACES,   _______,  _______,           _______,
