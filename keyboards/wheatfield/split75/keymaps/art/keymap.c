...
KC_4,  KC_5,    _______,  _______,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_PGDOWN,            _______,  CTR_ALT,   KC_RSFT, CTR_ALT_SHIFT, _______, _______, _______,          _______,
KC_2,  KC_3,    _______,  _______, LCTL(KC_X),LCTL(KC_C),LCTL(KC_V), _______,           _______,  _______,   _______,  _______,  _______,                      _______,  _______, _______,
...
//--------------------------------Left Hand-----------------------------------------------| |--------------------------------Right Hand------------------------------------------------
                      _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,
_______,  _______,    TILD_BLOCK, PRESCRIPTION, QUOTES_RU, _______,  FOURS,  _______,  _______,         _______,   STARS,    PARENTHS, _______,  DASHES,   _______,  _______,           _______,
_______,  _______,    _______,  _______,  _______,  _______, NEUTRAL_COPY, BEAT_BROWSER,      _______,  _______,   _______,  _______,  _______,  BRACES,   TOG_OS,   _______,           _______,
