...
[QWERTY] = LAYOUT_ergodox(
  ...
  KC_LEFT,          KC_RIGHT,     KC_LWIN,    KC_LALT,    KC_LCTL,
                             ...
                             LT(MEDIA,KC_LEFT), LT(COMBOS,KC_RIGHT),
                                                      KC_UP,
                          LT(NAV,KC_SPC),  KC_BSPC,   KC_DOWN,

  // -----------------------------------------------------right hand-----------------------------------------------------
  KC_MINS,          KC_6,         KC_7,       KC_8,       KC_9,              KC_0,      KC_RBRC,
  KC_EQL,           KC_Y,         KC_U,       KC_I,       KC_O,              KC_P,      KC_LBRC,
                    KC_H,         KC_J,       KC_K,       KC_L,              KC_SCLN,  LT(GIT,KC_QUOT),
  KC_CAPS,          KC_N,         KC_M,       KC_COMM,    KC_DOT,            KC_SLSH,   KC_RSFT,
                                  KC_RALT,    KC_HOME,    KC_END,        TO(GAMING),    KC_RCTL,

    KC_LEFT,                KC_RIGHT,
    LT(MEDIA,KC_UP),
    LT(COMBOS,KC_DOWN), TT(NAV), KC_ENT
),
/* Workman
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
[WORKMAN] = LAYOUT_ergodox(
  ...
  _______,          KC_K,         KC_L,       _______,    _______,           _______,   _______,
                                  _______,    _______,    _______,          TO(QWERTY), _______,
...
[GAMING] = LAYOUT_ergodox(
  ...
  KC_LCTL,          KC_Z,         KC_X,       KC_C,       KC_V,              KC_B,      TO(WORKMAN),
  KC_LEFT,          KC_RIGHT,     KC_LWIN,    KC_LALT,    KC_RCTL,
 ...
 LT(MEDIA,KC_CAPS), KC_N,         KC_M,       KC_COMM,    KC_DOT,            KC_SLSH,   KC_RSFT,
                                  KC_RALT,    KC_HOME,    KC_END,           TO(QWERTY), KC_RCTL,
...
[COMBOS] = LAYOUT_ergodox(
  ...
  _______,          _______,          _______,          NEUTRAL_COPY,     _______,          _______,          _______,
...
[MEDIA] = LAYOUT_ergodox(
  // -----------------------------------------------------left hand-----------------------------------------------------
  _______,          _______,          _______,          _______,          _______,          KC_VOLU,          KC_MPLY,
  _______,          _______,          _______,          _______,          KC_MPRV,          KC_MUTE,          KC_MNXT,
...
[GIT] = LAYOUT_ergodox(
  ...
  _______,          G_ADD,            G_S,              G_HEAD,           _______,          _______,
